(() => {
  ...
  // ../popsicle_sale/popsicle_sale/popsicle_sale/page/mobile_point_of_sale/pos_item_selector.js
  var import_onscan = __toESM(require_onscan());
  popsicle_sale.MobilePointOfSale.ItemSelector = class {
  ...
  // ../popsicle_sale/popsicle_sale/popsicle_sale/page/mobile_point_of_sale/pos_item_cart.js
  popsicle_sale.MobilePointOfSale.ItemCart = class {
    ...
    make_cart_numpad() {
      ...
      this.number_pad = new popsicle_sale.MobilePointOfSale.NumberPad({
  ...
  // ../popsicle_sale/popsicle_sale/popsicle_sale/page/mobile_point_of_sale/pos_item_details.js
  popsicle_sale.MobilePointOfSale.ItemDetails = class {
    constructor({ wrapper, events, settings }) {
      this.wrapper = wrapper;
      this.events = events;
      this.hide_images = settings.hide_images;
...
`);
  ...
  // ../popsicle_sale/popsicle_sale/popsicle_sale/page/mobile_point_of_sale/pos_number_pad.js
  popsicle_sale.MobilePointOfSale.NumberPad = class {
  ...
  // ../popsicle_sale/popsicle_sale/popsicle_sale/page/mobile_point_of_sale/pos_payment.js
  popsicle_sale.MobilePointOfSale.Payment = class {
  ...
  popsicle_sale.MobilePointOfSale.PastOrderList = class {
...
Return`,
  ...
  popsicle_sale.MobilePointOfSale.Controller = class {
    ...
    prepare_dom() {
      this.wrapper.append(`<div class="point-of-sale-app mobile-point-of-sale-app"></div>`);
      this.$components_wrapper = this.wrapper.find(".mobile-point-of-sale-app");
    }
    prepare_components() {
      this.init_pagination_toolbar();
    ...
    init_item_selector() {
      this.item_selector = new popsicle_sale.MobilePointOfSale.ItemSelector({
        wrapper: this.$components_wrapper,
    ...
    init_item_cart() {
      this.cart = new popsicle_sale.MobilePointOfSale.ItemCart({
        wrapper: this.$components_wrapper,
        settings: this.settings,
        events: {
          get_frm: () => this.frm,
    ...
    init_item_details() {
      this.item_details = new popsicle_sale.MobilePointOfSale.ItemDetails({
        wrapper: this.$components_wrapper,
        settings: this.settings,
        events: {
          get_frm: () => this.frm,
...
`);
    ...
    init_payments() {
      this.payment = new popsicle_sale.MobilePointOfSale.Payment({
        wrapper: this.$components_wrapper,
        events: {
          get_frm: () => this.frm || {},
    ...
    init_recent_order_list() {
      this.recent_order_list = new popsicle_sale.MobilePointOfSale.PastOrderList({
        wrapper: this.$components_wrapper,
        events: {
    ...
    init_order_summary() {
      this.order_summary = new popsicle_sale.MobilePointOfSale.PastOrderSummary({
        wrapper: this.$components_wrapper,
        events: {
          get_frm: () => this.frm,
          process_return: (name) => {
